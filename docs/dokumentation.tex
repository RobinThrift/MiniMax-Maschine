...
\textbf{Berechnung:}\\\\
Für den ersten Benchmark: $t_{bewertet} = 16201 * (1 + 0,1*9 + 0,015*6 + 0,05 * 7) = 5672,3$\\\\
Für den zweiten Benchmark: $t_{bewertet} = 27067 * (1 + 0,1*9 + 0,015*6 + 0,05 * 7) = 9475,4$\\\\
Für den dritten Benchmark: $t_{bewertet} = 31451 * (1 + 0,1*9 + 0,015*6 + 0,05 * 7) = 11009,7$\\

\subsubsection{Algorithmuslänge}
Die Algorithmuslänge wird in Zeilen angegeben.\\

\textbf{Berechnung:} $n_{bewertet} = 28 + 5*9 + 3*12 + 5*7 = 144$

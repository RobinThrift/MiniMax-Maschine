...
Die Laufzeit beschreibt die Takte, die von der Maschine gebraucht werden um unser Ergebnis zu erzeugen. Leider war es nicht möglich mit unserem ersten Algorithmus den ersten Benchmark fehlerfrei zu behandeln.  $t_{bench}$ beträgt in unserem Fall 3019 Takte für den zweiten Benchmark und <palceholder>\\

...
\textbf{Berechnung:}\\\\
Für den ersten Benchmark: $t_{bewertet} = 16201 * (1 + 0,1*9 + 0,015*6 + 0,05 * 8) = 38720,4$\\\\
Für den zweiten Benchmark: $t_{bewertet} = 27067 * (1 + 0,1*9 + 0,015*6 + 0,05 * 8) = 64690,4$\\\\
Für den dritten Benchmark: $t_{bewertet} = 31451 * (1 + 0,1*9 + 0,015*6 + 0,05 * 8) = 75167,9$\\

...
Kopf mit einer L{\"a}nge von 80 Bits und einem Datenteil mit variabler L{\"a}nge. Der Kopf enth{\"a}lt die Kanalnummer zwischen der 32. und 47. Bitstelle. Zu einem Kanal k{\"ö}nnen ein oder mehrere Pakete geh{\"ö}ren, welche die selbe Kanalnummer haben.
...
weitere k{\"ö}nnen hinzuge{\"u}fgt werden), einer arithmetisch-logischen Einheit (ALU) und einem Hauptspeicher (HS) aufgebaut
ist und durch ein Mikropgramm gesteuert wird. Dabei sind die m{\"ö}glichen Operationen auf die in der ALU implementieren
...
entweder in einem Register oder im HS (Adresse im Register `MAR`) gespeichert werden. Zus{\"a}tzlich k{\"ö}nnen s. g. Flags 
...
32-Bit Zahlen auslesen k{\"ö}nnen und nicht als einzelne Bits.

...
zu finden muss mit diesem Muster also "'Maskiert'" werden. Dies geschieht {\"u}ber die bitweise Undverkn{\"u}pfung der eingelsenen Zahl und dem Muster. F{\"u}r die Minimax-Maschine
heißt das konkret: 14 & ZAHL bitweise Undverkn{\"u}pfen. Folglich wird die Basismaschine um die Konstante 14 ($=1110_{2}$) und eine bitweise UND-Operation
erweitert. Um zu {\"u}berpr{\"u}fen ob diese
...
\includegraphics[width=13cm]{docs/readFromMemory.png}

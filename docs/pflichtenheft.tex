...
\usepackage{ngerman,xunicode,graphicx}
...
und der ALU muss {\"u}ber die \texttt{ALU Ctrl}-Leitung der Code f{\"u}r die Operation {\"u}bergben werden. Das Ergebnis der Operation kann

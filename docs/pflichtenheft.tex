...
\usepackage{ngerman,amsmath,graphicx,a4wide,fontspec}
...
extrahiert und dem Speicherprogramm übergeben. Nach dem Speichervorgang überspringt das Programm SKIP weiteren Bits des Paketes (Siehe Abb. 2 im Anhang).

\subsection{Überspringen der nicht benötigten Bits des Paketes}
Da sowohl die Länge des Headers (80 Bit) als auch die Länge des Datenpaketes (im Register \texttt{LNGTH} gepsichert) bekannt ist, kann durch
...
inkrementiert und das Programm zum Überspringen wird beendet (Siehe Abb. 3 im Anhang).
...
\subsection{Abb. 3: Flussdiagramm des Programms zum Überspringen des Datenfeldes}

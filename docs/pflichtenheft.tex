...
\begin{enumerate} 
\item Wikipedia: "'Mask (computing)'" [http://en.wikipedia.org/wiki/Mask_(computing)]
\item Wikipedia: "'Bitweiser Operator'" [http://de.wikipedia.org/wiki/Bitweiser_Operator]
...
\item Materialen der Veranstaltung "Grundlagen der Rechnerarchitektur" von Prof. Dr.-Ing. habil. Jürgen Brehm
\end{enumerate}
